...
1. 安装本地服务：
   ...
   `~/Library/LaunchAgents/com.tiantianquan.local.plist`，启动本地服务，并自动生成内部 router token。日志会写到 `~/Library/Logs/Tiantianquan`。
...
```text
~/.local/share/tiantianquan/tasks/YYYY-MM-DD.jsonl
```
